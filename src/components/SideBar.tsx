...
function SideBar() {
  ...
  return (
    <div className='flex flex-col items-center p-2 md:p-10 border-b border-indigo-500/50'>
     ...
     <Image src={require("../../public/sca.png")} alt="scraper" className='text-indigo-600' height="100" width="100" />
   <h1 className='hidden md:inline text-3xl mt-3 pb-2'>Web Scraper</h1>
   <h1 className='hidden md:inline text-center'>Scraping the Unscrapable!!!</h1>
     </div>
